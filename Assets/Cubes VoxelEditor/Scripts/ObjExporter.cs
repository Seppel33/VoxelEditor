...
public class ObjExporter
{
    ...
    private static string MeshToString(MeshFilter mf, Renderer rend, string filename, float scale)
    {
        Mesh m = mf.mesh;
        ...
        {
            sb.Append(string.Format("v {0} {1} {2}\n", v.x * scale, (v.y + 0.5f) * scale, v.z * scale).Replace(",", "."));
        }
        sb.Append("\n");
        ...
        {
            sb.Append("\n");
            sb.Append("usemtl ").Append(ColorUtility.ToHtmlStringRGB(mats[material].GetColor("_Color"))).Append("\n");
            sb.Append("usemap ").Append(ColorUtility.ToHtmlStringRGB(mats[material].GetColor("_Color"))).Append("\n");
