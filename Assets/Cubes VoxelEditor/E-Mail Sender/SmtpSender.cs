...
namespace EmailSender
{
    ...
    public class SmtpSender : IRichMessageEmailSender {
        ...
        public void Send(String from, String to, String subject, String messageText, MessageAttachmentList messageAttachments) {
            if (from == null) throw new ArgumentNullException("from");
            if (to == null) throw new ArgumentNullException("to");
            if (subject == null) throw new ArgumentNullException("subject");
            if (messageText == null) throw new ArgumentNullException("messageText");

            Send(new Message(from, to, subject, messageText, messageAttachments));
        }
        public void Send(String from, String to, String subject, String messageText)
        {
            ...
            Send(new Message(from, to, subject, messageText, new MessageAttachmentList()));
        }
        ...
        private static MailMessage CreateMailMessage(Message message) {
            ...
            mailMessage.From = new MailAddress(message.From, "Cubes");
